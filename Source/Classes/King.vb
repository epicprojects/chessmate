...
Public Class King
    Inherits Piece
    Public KingCount(1, 2) As Integer
    Public Sub New()
    ...
    Public Sub setLocation(ByVal X As Integer, ByVal Y As Integer)
        ...
        KingCount(0, 1) = Y
    End Sub
    Public Sub initKing(ByVal IndexNUmber As Integer, ByVal X As Integer, ByVal Y As Integer)
        setLocation(X, Y)
    End Sub
    Public Function getLocation() As String
        Dim location As String = ""
        location = location & KingCount(0, 0) & ","
        location = location & KingCount(0, 1)
        Return location
    End Function
